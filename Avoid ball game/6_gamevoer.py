...
# 화면 타이틀 설정
pygame.display.set_caption("Mio Pang") # 게임 이름
...
# 게임 종류 메시지 / TimeOut, Mission Complete, Game Over
...
while running :
    ...
    # 무기 위치 조정
    weapons = [[w[0], w[1] - weapon_speed] for w in weapons] # 무기 위치롤 위로
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        # 가로벽에 닿았응ㄹ 때 공 이동 위치 변경 (튕벼 나오는 효과)
